...
import { jsonTitleCardElements } from '../../constants/TestCasesMapping/jsonTitleCardElements';
import { CodeContainer } from '../codeContainer';
import TypeForm from './forms/typeForm';

interface ObjTitleCardProps {
...
export const ObjTitleCard: React.FC<ObjTitleCardProps> = ({ jsonPath, jsonKey, jsonValue, onSaveJson }) => {
  const {
    elementToEditType,
        ...
        <Column>
          ...
          {jsonValue && typeof jsonValue === 'object' && (
            <>
              ...
              <CodeContainer code={`${JSON.stringify([...jsonPath, jsonKey])}`} copyable={true} />
            </>
          )}
        </Column>
      </Row>
