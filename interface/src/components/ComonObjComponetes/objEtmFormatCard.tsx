...
import { jsonEtmFormatCardElements } from '../../constants/TestCasesMapping/jsonEtmFormatElement';
import TypeForm from './forms/typeForm';
import ValidationForm from './forms/validationForm';
import DefaultForm from './forms/defaultForm';
import ContentForm from './forms/contentForm';
interface ObjEtmFormatCardProps {
...
export const ObjEtmFormatCard: React.FC<ObjEtmFormatCardProps> = ({ jsonPath, jsonKey, jsonValue, onSaveJson }) => {
  const {
    elementToEditType,
